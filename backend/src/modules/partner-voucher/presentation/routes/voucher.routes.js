...
router.post("/:id/approve", authenticateMiddleware, controller.approve.bind(controller));
router.post("/:id/reject", authenticateMiddleware, controller.reject.bind(controller));
