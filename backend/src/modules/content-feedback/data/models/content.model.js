...
class ContentModel {
  constructor({ ma_nd, loai, tieu_de, noi_dung, trang_thai, bat_dau_hien_thi, ket_thuc_hien_thi, ngay_tao, ngay_cap_nhat, matk_admin, hinh_anh_url }) {
    this.id = ma_nd;
    this.type = loai;
    this.title = tieu_de;
