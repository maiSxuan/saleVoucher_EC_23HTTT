...
const INITIAL_PARTNERS = [
    ...
    branches: [
      {
        ...
        ten_chi_nhanh: "Ẩm Thực Sài Gòn - Nguyễn Huệ",
      ...
      {
        ma_chi_nhanh: "30000000-0000-0000-0000-000000000002",
        ten_chi_nhanh: "Ẩm Thực Sài Gòn - Võ Văn Tần",
        khu_vuc: "TP. Hồ Chí Minh",
        dia_chi: "120 Võ Văn Tần, TP. Hồ Chí Minh",
        trang_thai: "Dang hoat dong",
        sdt: "02838223344",
  ...
  },
  {
    ...
    branches: [
      {
        ma_chi_nhanh: "30000000-0000-0000-0000-000000000004",
        ten_chi_nhanh: "Spa An Nhiên - Thành Thái",
        khu_vuc: "TP. Hồ Chí Minh",
        dia_chi: "25 Thành Thái, TP. Hồ Chí Minh",
        trang_thai: "Cho duyet",
        sdt: "02439887766",
...
const INITIAL_BRANCH_REQUESTS = [
  {
    ...
    ten_chi_nhanh: "Ẩm Thực Sài Gòn - Landmark 81",
    khu_vuc: "TP. Hồ Chí Minh",
