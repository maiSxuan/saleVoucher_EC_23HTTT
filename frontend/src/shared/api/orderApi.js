...
export async function submitOrderComplaint(id, { maVoucherMua, noiDung }) {
  const res = await fetch(`${BASE_URL}/orders/${id}/complaints`, {
    method: "POST",
    headers: authHeaders(),
...
export async function submitOrderReview(id, { maVoucherMua, diem, noiDung }) {
  const res = await fetch(`${BASE_URL}/orders/${id}/reviews`, {
    method: "POST",
    headers: authHeaders(),
...
export async function customerCancelOrder(id, { reason }) {
  const res = await fetch(`${BASE_URL}/orders/${id}/request-cancel`, {
    method: "POST",
    headers: authHeaders(),
