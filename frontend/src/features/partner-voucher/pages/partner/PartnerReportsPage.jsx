...
export function PartnerReportsPage() {
  ...
  const kpis = [
    ...
    { label: "Tổng voucher đã bán", value: totalSold.toLocaleString(), icon: <ShoppingCart size={20} />, color: "mint" },
  ...
  return (
    <PartnerLayout>
      <div className="p-6 max-w-7xl mx-auto space-y-6">
        <div>
          <h1 className="text-2xl font-bold text-snow-900">Báo cáo Đối tác</h1>
          <p className="text-sm text-snow-600 mt-1">Hiệu quả kinh doanh và phát hành voucher của doanh nghiệp</p>
        </div>
  ...
  <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
    <div className="sm:col-span-2">
      <label className="block text-xs font-semibold text-gray-600 mb-1.5">
        Chương trình voucher <span className="text-semantic-error">*</span>
      </label>
      <select
    ...
    <div>
      <label className="block text-xs font-semibold text-gray-600 mb-1.5">
        Từ ngày <span className="text-semantic-error">*</span>
      </label>
      <input
        type="date"
        value={startDate}
    ...
    <div>
      <label className="block text-xs font-semibold text-gray-600 mb-1.5">
        Đến ngày <span className="text-semantic-error">*</span>
      </label>
      <input
        type="date"
        value={endDate}
      ...
      Cập nhật báo cáo
        ...
        {!loading && emptyReason === "error" && (
          <div className="bg-semantic-error-soft border border-semantic-error-border rounded-xl p-8 flex flex-col items-center text-center">
            ...
            <h3 className="font-semibold text-semantic-error mb-1">Không thể tải dữ liệu báo cáo</h3>
            <p className="text-sm text-semantic-error mb-4">Lỗi kết nối máy chủ. Vui lòng thử lại.</p>
            <button
              onClick={fetchReport}
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-4">
              ...
              <ResponsiveContainer width="100%" height={180}>
                <BarChart data={filteredData} layout="vertical">
                  ...
                  <Bar dataKey="sold" fill="var(--brand-primary)" name="Đã bán" />
                  <Bar dataKey="used" fill="var(--brand-success)" name="Đã sử dụng" />
                </BarChart>
              </ResponsiveContainer>
            </div>
          </>
