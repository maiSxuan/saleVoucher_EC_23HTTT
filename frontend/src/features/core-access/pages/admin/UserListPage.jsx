...
const STATUS_CONFIG = {
  ...
  // Trạng thái đơn hàng
  'Da thanh toan': { label: 'Đã thanh toán', dotClass: 'bg-green-500', textClass: 'text-green-700 bg-green-50 border border-green-200' },
  'Cho hoan tien': { label: 'Chờ hoàn tiền', dotClass: 'bg-yellow-500', textClass: 'text-yellow-700 bg-yellow-50 border border-yellow-200' },
  'Da hoan tien': { label: 'Đã hoàn tiền', dotClass: 'bg-blue-500', textClass: 'text-blue-700 bg-blue-50 border border-blue-200' },
  'Huy yeu cau hoan tien': { label: 'Hủy hoàn tiền', dotClass: 'bg-red-500', textClass: 'text-red-700 bg-red-50 border border-red-200' },
  'Da huy': { label: 'Đã hủy', dotClass: 'bg-gray-500', textClass: 'text-gray-700 bg-gray-50 border border-gray-200' },
};
